...
import us.codecraft.spider.samples.NjuBBSProcessor;
...
public class SpiderTest {
    ...
    public void testSpider() throws InterruptedException {
        Spider me = Spider.me().pipeline(new FilePipeline()).processor(new NjuBBSProcessor());
        me.run();
    }
    ...
    public void testGlobalSpider(){
        ...
        Spider.me().pipeline(new FilePipeline()).schedular(new FileCacheQueueSchedular(pageProcessor.getSite(),"/Users/Knight/Documents/webmagicFiles/data/temp/spider/cache/")).
        ...
        Spider.me().pipeline(new FilePipeline()).schedular(new FileCacheQueueSchedular(pageProcessor2.getSite(),"/Users/Knight/Documents/webmagicFiles/data/temp/spider/cache/")).
